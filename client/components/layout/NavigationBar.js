...
export default function NavigationBar(props) {
    ...
    const activeClass = "bg-gray-text-white px-3 py-2 rounded-md text-sm font-medium";
    ...
    return (
        <>
            <nav className="bg-blue-900 top-0 fixed z-50 w-full shadow" >
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-4 flex items-center md:ml-6">
                                <button className="bg-gray-800 p-1 rounded-full text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                ...
                <div className="md:hidden" id="mobile-menu">
                    ...
                    <div className="pt-4 pb-3 border-t border-gray-700">
                        ...
                        <div className="mt-3 px-2 space-y-1">
                            ...
                            <a   onClick={onSubmit} class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">
                                Sign out
                            </a>
                            :null
